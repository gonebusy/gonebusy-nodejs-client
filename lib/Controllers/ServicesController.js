...
class ServicesController {
     ...
     * @param {uuid|string} userId (optional) Retrieve Services provided by the User specified by
     ...
     * @returns {Promise}
     */
    static getServices(authorization, userId, page, perPage, callback) {
     ...
     * @param {date} date (optional) Date to check for availability.  Either this field or a date
     * range employing start_date and end_date must be supplied.  If date is
     * provided, start_date/end_date are ignored.  Several formats are supported:
     * '2014-10-31', 'October 31, 2014'.
     * @param {date} startDate (optional) Start Date of a range to check for availability.  If
     * supplied, date must not be supplied and end_date must be supplied.
     * Several formats are supported: '2014-10-31', 'October 31, 2014'.
     * @param {date} endDate (optional) End Date of a range to check for availability.  If supplied,
     * date must not be supplied and start_date must be supplied.  Several
     * formats are supported: '2014-10-31', 'October 31, 2014'.
     * @param {uuid|string} resourceId (optional) Retrieve available slots only for this Resource.
     * You must be authorized to manage this Resource.
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static getServiceAvailableSlotsById(authorization,
        id,
        date,
        startDate,
        endDate,
        ...
        _queryBuilder = _apiHelper.appendUrlWithQueryParameters(_queryBuilder, {
            ...
            start_date: _apiHelper.stringifyDateTime(startDate, 'date'),
