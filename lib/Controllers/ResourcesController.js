...
var ResourcesController = {
    ...
    deleteResourceById: function (input, callback) {
        ...
        function cb (_error, _response, _context) {
            if(_error) {
                ...
                parsed = new DeleteResourceByIdResponse(parsed);
    ...
    updateResourceById: function (input, callback) {
        ...
        function cb (_error, _response, _context) {
            if(_error) {
                ...
                var parsed = JSON.parse(_response.body);
                parsed = new UpdateResourceByIdResponse(parsed);
                callback(null,parsed,_context);
            } else if (_response.statusCode == 400) {
                callback({errorMessage: "Bad Request", errorCode: 400, errorResponse:_response.body}, null, _context);
            } else if (_response.statusCode == 401) {
    ...
    getResourceById: function (input, callback) {
        ...
        function cb (_error, _response, _context) {
            if(_error) {
                ...
                var parsed = JSON.parse(_response.body);
                parsed = new GetResourceByIdResponse(parsed);
                callback(null,parsed,_context);
            } else if (_response.statusCode == 400) {
                callback({errorMessage: "Bad Request", errorCode: 400, errorResponse:_response.body}, null, _context);
            } else if (_response.statusCode == 401) {
    ...
    getResourceThings: function (input, callback) {
        ...
        function cb (_error, _response, _context) {
            if(_error) {
                ...
                var parsed = JSON.parse(_response.body);
                parsed = new GetResourceThingsResponse(parsed);
                callback(null,parsed,_context);
            } else if (_response.statusCode == 400) {
                callback({errorMessage: "Bad Request", errorCode: 400, errorResponse:_response.body}, null, _context);
            } else if (_response.statusCode == 401) {
     ...
     */
    createResource: function (input, callback) {
        //Assign default values
        input = input || {};
        ...
        function cb (_error, _response, _context) {
            if(_error) {
                ...
                var parsed = JSON.parse(_response.body);
                parsed = new CreateResourceResponse(parsed);
                callback(null,parsed,_context);
            } else if (_response.statusCode == 400) {
                callback({errorMessage: "Bad Request", errorCode: 400, errorResponse:_response.body}, null, _context);
            } else if (_response.statusCode == 401) {
    ...
    getResources: function (input, callback) {
        ...
        function cb (_error, _response, _context) {
            if(_error) {
                ...
                var parsed = JSON.parse(_response.body);
                parsed = new GetResourcesResponse(parsed);
                callback(null,parsed,_context);
            } else if (_response.statusCode == 401) {
                callback({errorMessage: "Unauthorized/Missing Token", errorCode: 401, errorResponse:_response.body}, null, _context);
            } else if (_response.statusCode == 403) {
