...
class BookingsController {
     ...
     *
     * @param {string} authorization A valid API key, in the format 'Token API_KEY'
     * @param {int} userId (optional) Retrieve Bookings for Resources/Services owned by this User
     * Id.  You must be authorized to manage this User Id.
     ...
     * @param {int} bookerId (optional) Retrieve Bookings made by Booker Id.  Only Bookings for
