...
class BookingsController {
     ...
     * @param {date} date (optional) If a recurring booking, the date of an instance to cancel.
     * Several formats are supported: '2014-10-31', 'October 31, 2014'
     * @param {date} endDate (optional) If recurring, cancel up to :end_date or leave blank for
     ...
     * @returns {Promise}
     */
    static cancelBookingById(authorization, id, date, endDate, cancelRecurring, callback) {
        ...
        _queryBuilder = _apiHelper.appendUrlWithQueryParameters(_queryBuilder, {
            date: _apiHelper.stringifyDateTime(date, 'date'),
            end_date: _apiHelper.stringifyDateTime(endDate, 'date'),
     ...
     *
     * @param {string} authorization A valid API key, in the format 'Token API_KEY'
     * @param {uuid|string} userId (optional) Retrieve Bookings for Resources/Services owned by
     * this User Id.  You must be authorized to manage this User Id.
     ...
     * @param {uuid|string} bookerId (optional) Retrieve Bookings made by Booker Id.  Only Bookings
     * for Services/Resources you are authorized to manage will be
     * returned.
     ...
     * @returns {Promise}
     */
    static getBookings(authorization, userId, states, bookerId, page, perPage, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
