...
class SchedulesController {
     ...
     *
     * @param {string} authorization A valid API key, in the format 'Token API_KEY'
     * @param {uuid|string} userId (optional) Retrieve Schedules owned only by this User Id.  You
     * must be authorized to manage this User Id.
     * @param {uuid|string} resourceId (optional) Retrieve Schedules only for this Resource.  You,
     * or provided :user_id, must be authorized to manage this
     * Resource.
     * @param {uuid|string} serviceId (optional) Retrieve Schedules only for this Service.  You, or
