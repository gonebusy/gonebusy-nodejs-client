...
var PricingModelsController = {
     ...
     * @return {promise}
     */
    updatePricingModelById: function (input) {
        ...
        function formatter (_data) {
            _data.data = new UpdatePricingModelByIdResponse(_data.data);
            return _data;
        }
     ...
     * @return {promise}
     */
    getPricingModelById: function (input) {
        //Assign default values
        input = input || {};
        ...
        //Build the response processing.
        function formatter (_data) {
            _data.data = new GetPricingModelByIdResponse(_data.data);
            return _data;
        }
        return _request(_options).then(formatter);
    },
     ...
     * @return {promise}
     */
    createPricingModel: function (input) {
        //Assign default values
        input = input || {};
        ...
        //Build the response processing.
        function formatter (_data) {
            _data.data = new CreatePricingModelResponse(_data.data);
            return _data;
        }
        return _request(_options).then(formatter);
    },
     ...
     * @return {promise}
     */
    getPricingModels: function (input) {
        //Assign default values
        input = input || {};
        ...
        //Build the response processing.
        function formatter (_data) {
            _data.data = new GetPricingModelsResponse(_data.data);
            return _data;
        }
        return _request(_options).then(formatter);
    }
